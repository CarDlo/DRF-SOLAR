...
class BayuncaAdmin(admin.ModelAdmin):
    fields = ('REG_CA', 'direccion', 'value', 'plant_id', 'created_at')
    list_display = ('REG_CA', 'direccion', 'value', 'plant_id', 'created_at')
    search_fields = ('REG_CA', 'direccion')
    list_filter = ('created_at',)
admin.site.register(Bayunca, BayuncaAdmin)

class LaVillaAdmin(admin.ModelAdmin):
    fields = ('REG_CA', 'direccion', 'value', 'created_at')
    list_display = ('REG_CA', 'direccion', 'value', 'created_at')
    search_fields = ('REG_CA', 'direccion')
    list_filter = ('created_at',)
